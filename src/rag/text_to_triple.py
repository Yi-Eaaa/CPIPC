...
class Text2Triple:
    ...
    def generate_triple(self, text: str, return_json=False):
        """
        ...
        """
        input_encodings = Text2Triple.tokenizer(
            text,
        ...
        with torch.no_grad():
            generated_ids = Text2Triple.model.generate(
                input_ids,
                max_length=512,
                num_beams=4,
                early_stopping=True,
        ...
        triple = Text2Triple.tokenizer.batch_decode(generated_ids, skip_special_tokens=True)[0]
